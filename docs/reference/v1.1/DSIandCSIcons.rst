...
MIPI CSI interface is used for serial camera. Detail camera 1 connector J18 pinout is as shown in table 12.

.. list-table:: Table 12. MIPI CSI camera 1 connector (J18) pinout
   :header-rows: 1
   :stub-columns: 1
