...
.. figure:: /images/LimePSB-RPCM_v1.1_diagrams_r1_RFFE.png
  ...
  Figure 6: LimePSB RPCM v1.1 RFFE diagram
...
.. list-table:: Table 6. RF path truth table
   :header-rows: 1

   * - Control signal (RF_SW_TDD)
     - TRXA/B connected to
     - RXA/B connected to
   * - Low
     - TXA/B_IN
...
.. list-table:: Table 7. RF path signal frequency range
   :header-rows: 1
...
LimePSB RPCM RF front end uses same design as Front End Adapter. For more information about the design check `LimeFEA mPCIe documentation`_.

.. _LimeFEA mPCIe documentation: https://limefea-mpcie.myriadrf.org/