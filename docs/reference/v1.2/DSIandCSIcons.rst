...
MIPI CSI interface is used for serial camera. Detail camera 1 connector J16 pinout is as shown in table 13.

.. list-table:: Table 13. MIPI CSI camera 1 connector (J16) pinout
   :header-rows: 1
   :stub-columns: 1
