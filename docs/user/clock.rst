...
The LimeSDR USB clock system is based on a high stability 30.72 MHz and 10 MHz VCTCXOs (Voltage Controlled Temperature Compensated Crystal Oscillators) which can be tuned via an external 1PPS reference signal or GPSDO function.
