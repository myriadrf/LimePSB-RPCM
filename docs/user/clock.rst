...
The LimePSB RPCM clock system is based on a high stability 30.72 MHz and 10 MHz VCTCXOs (Voltage Controlled Temperature Compensated Crystal Oscillators) which can be tuned via an external 1PPS reference signal or GPSDO function.
...
.. table:: Table 2. Clock Functions
  ...
  +======================+===================+=====================================+
  |  On-board Oscillator | 30.72 MHz VCTCXO  | U7475LF                             |
  |                      +-------------------+-------------------------------------+
  |                      | 10 MHz VCTCXO     | U8073LF                             |
  +----------------------+-------------------+-------------------------------------+
